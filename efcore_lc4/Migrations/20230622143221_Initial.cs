        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActorPicture = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieGenre = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    MovieDuration = table.Column<int>(type: "int", nullable: false),
                    MovieBudget = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
